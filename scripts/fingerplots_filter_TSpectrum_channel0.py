...
plt.title('Fingerplot after filtering with TSpectrum channel 0 Threshold=0.5')
plt.savefig('../finger_plots/test_FP_filtered_TSpectrum_threshold_ch0_threshold_0_5.pdf')

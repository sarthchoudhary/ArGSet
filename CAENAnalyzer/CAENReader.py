...
# Store the values in the trigger object
        trigger.eventSize = eventSize #new
        trigger.boardId = boardId #new
        trigger.channelUse = channelUse #new
        trigger.numChannels = numChannels #new
...
class RawTrigger:
    def __init__(self):
        ...
        self.triggerTime = 0.
        self.eventCounter = 0
        self.eventSize = 0 #new 
        self.boardId = 0 #new
        self.channelUse = 0 #new
        self.numChannels = 0 #new

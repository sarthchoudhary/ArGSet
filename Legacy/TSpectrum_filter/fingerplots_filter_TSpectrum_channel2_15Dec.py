...
for seg_index in range(segment_index_begin, segment_index_end+1):
    ...
    binary_segment_name = f'/work/sarthak/ArgSet/2023_12_15/Run_2/run0_raw_b0_seg{seg_index}.bin' # path on chuck
...
plt.hist(integration_vector, bins=np.arange(0, 50000, 20), color='C2', label='tr2')
...
plt.title('Fingerplot after filtering with TSpectrum channel 2 Threshold=0.5 15Dec Run2')
plt.savefig('/home/sarthak/my_projects/argset/finger_plots/FP_filtered_TSpectrum_ch2_Threshold_0_5_15Dec_Run2.pdf')
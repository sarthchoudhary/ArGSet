#!/bin/bash
#SBATCH --job-name=ArgSet_analysis_fingerplots_Ch1_15Dec    # Job name
...
python /home/sarthak/my_projects/argset/scripts/fingerplots_filter_TSpectrum_channel1_15Dec.py